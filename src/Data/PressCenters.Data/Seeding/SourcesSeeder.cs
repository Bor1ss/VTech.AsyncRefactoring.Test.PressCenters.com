                ...
                List<(string TypeName, string ShortName, string Name, string Description, string Url, string DefaultImageUrl)>
                    {
                        ...
                        ("PressCenters.Services.Sources.Ministries.MzhGovernmentBgSource", "МЗХГ",
                            ...
                            "Министерството на земеделието е висш върховен орган на държавната власт който провежда държавната политика в областта на селското стопанство и горите.",
                            "https://www.mzh.government.bg/", "/images/sources/mzh.government.bg.png"),
                        ...
                        ("PressCenters.Services.Sources.Ministries.MiGovernmentBgSource", "МИИ",
                            "Министерство на икономиката и индустрията",
                            "Министерството на икономиката и индустрията (МИИ) е българска държавна институция с ранг на министерство, която води икономическата политика на страната.",
                        ...
                        ("PressCenters.Services.Sources.Ministries.MtitcGovernmentBgSource", "МТС",
                            ...
                            "https://www.mtc.government.bg/", "/images/sources/mtitc.government.bg.jpg"),
                        ...
                        ("PressCenters.Services.Sources.Ministries.EgovGovernmentBgSource", "МЕУ", "Министерство на електронното управление",
                            "Министерство на електронното управление (МЕУ) е държавна институция в България с ранг на министерство, която работи върху направления като електронна идентификация, електронно гласуване, киберсигурност, отворени данни, както и съгласуването им с Европейския съюз.",
                            "https://egov.government.bg/", "/images/sources/egov.government.bg.jpg"),
                        ...
                        ("PressCenters.Services.Sources.BgInstitutions.ConstCourtBgSource", "КС",
                            ...
                            "https://www.constcourt.bg/", "/images/sources/constcourt.bg.png"),
                        ...
                        ("PressCenters.Services.Sources.BgInstitutions.NoiBgSource", "НОИ",
                            ...
                            "https://nssi.bg/", "/images/sources/noi.bg.jpg"),
                        ...
                        ("PressCenters.Services.Sources.BgInstitutions.VssJusticeBgSource", "ВСС",
                            ...
                            "https://vss.justice.bg/", "/images/sources/vss.justice.bg.jpg"),
                        ...
                        ("PressCenters.Services.Sources.BgInstitutions.VasBgSource", "ВАдвС",
                            "Висш адвокатски съвет",
                            "Висшият адвокатски съвет (ВАдвС) упражнява въховен дисциплиниран надзор над адвокатската колегия в България и работи за издигане престижа на морала на адвокатскато съсловие.",
                            "https://www.vas.bg/", "/images/sources/vas.bg.jpg"),
                        ("PressCenters.Services.Sources.BgInstitutions.CrcBgSource", "КРС",
                            "Комисия за регулиране на съобщенията",
                            "Дейността на Комисията за регулиране на съобщенията (КРС) е насочена към осигуряване предоставянето на съвременни и качествени електронни съобщителни услуги на гражданите и бизнеса чрез създаване на условия за развитие на пазара на електронните съобщителни мрежи и услуги.",
                            "https://crc.bg/", "/images/sources/crc.bg.png"),
                        ("PressCenters.Services.Sources.BgInstitutions.DamtnGovernmentBgSource", "ДАМТН",
                            "Държавна агенция за метрологичен и технически надзор",
                            "Държавната агенция за метрологичен и технически надзор (ДАМТН) е държавен надзорен орган, осъществяващ дейности за осигуряване на проследимост, точност и достоверност на измерванията. ДАМТН осъществява надзор на пуснатите на пазара и/или пуснати в действие продукти, за които има съществени изисквания. ДАМТН осъществява контрол на качеството на течните горива.",
                            "https://www.damtn.government.bg/", "/images/sources/damtn.government.bg.jpg"),
                        ("PressCenters.Services.Sources.BgInstitutions.CemBgSource", "СЕМ",
                            "Съвет за електронни медии",
                            "Съветът за електронни медии (СЕМ) лицензира, регистрира и осъществява надзор върху дейността на доставчиците на медийни услуги. В дейността си той се ръководи от интересите на обществото, защитава свободата и плурализма на словото и информацията и независимостта на електронните медии.",
                            "https://www.cem.bg/", "/images/sources/cem.bg.jpg"),
                        ("PressCenters.Services.Sources.BgInstitutions.SacpGovernmentBgSource", "ДАЗД",
                            "Държавна агенция за закрила на детето",
                            "Държавната агенция за закрила на детето (ДАЗД) е създадена на основание Закона за закрила на детето. Агенцията е единственият специализиран орган на Министерския съвет за ръководство, координиране и контрол за осъществяване на държавната политика по дейности за закрила на детето в Република България.",
                            "https://sacp.government.bg/", "/images/sources/sacp.government.bg.png"),
                        ("PressCenters.Services.Sources.BgInstitutions.DvParliamentBgSource", "Държавен вестник",
                            "Държавен вестник",
                        ...
                        ("PressCenters.Services.Sources.BgInstitutions.CpcBgSource", "КЗК",
                            "Комисия за защита на конкуренцията",
                            "Комисия за защита на конкуренцията (КЗК) е независим специализиран държавен орган, който е оправомощен да прилага Закона за защита на конкуренцията (ЗЗК), Закона за обществените поръчки (ЗОП) и Закона за концесиите (ЗК). Комисията установява нарушения на свободната конкуренция.",
                            "https://www.cpc.bg/", "/images/sources/cpc.bg.jpg"),
                        ...
                        ("PressCenters.Services.Sources.BgStateCompanies.CezBgSource", "Електрохолд",
                            "\"Електрохолд България\"",
                            "\"Електрохолд България\" е енергийна компания в България. Занимава се с производство и търговия главно с електроенергия. Дружеството е 100% собственост на Ийстърн Юръпиън Електрик Къмпани Б.В., притежавана от Еврохолд България АД.",
                            "https://electrohold.bg/", "/images/sources/cez.bg.png"),
                        ...
                        ("PressCenters.Services.Sources.BgStateCompanies.SofiyskaVodaBgSource", "Софийска вода",
                            "\"Софийска вода\" АД",
                            "\"Софийска вода\" АД осигурява услугите водоснабдяване, канализация и пречистване на отпадъчните води на територията на Столична община.",
                            "https://www.sofiyskavoda.bg/", "/images/sources/sofiyskavoda.bg.png"),
                        ("PressCenters.Services.Sources.BgStateCompanies.IsBgNetSource", "ИО",
                            "\"Информационно обслужване\" АД",
                            "\"Информационно обслужване\" АД е основен партньор на държавни институции в изпълнението на ключови ИТ проекти. Компанията има екип с над 580 висококвалифицирани програмисти, комуникационни специалисти, системни администратори и сервизни инженери.",
                            "https://is-bg.net/", "/images/sources/is-bg.net.png"),
