namespace PressCenters.Web.Proxy
{
    ...
    public class ReverseProxyMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            var targetRequestMessage = await CreateTargetMessageAsync(context.Request, targetUri, replace);
        ...
        private static async Task<HttpRequestMessage> CreateTargetMessageAsync(HttpRequest originalRequest, Uri targetUri, bool replace)
        {
